				...
				<div className="bracket-container">
				  <div className="tournament-bracket tournament-bracket--rounded">
				    <div className="tournament-bracket__round tournament-bracket__round--quarterfinals">
				      ...
				      <ul className="tournament-bracket__list col-md-6 col-sm-6 col-xs-6">
				      	<Qualifier game="1" field="1" time="4:00pm" tournament="women"/>
				      </ul>
				    </div>
				  </div>
				</div>
				  ...
				  <div className="tournament-bracket tournament-bracket--rounded">
				    ...
				    <div className="tournament-bracket__round tournament-bracket__round--quarterfinals">
				      ...
				      <ul className="tournament-bracket__list">
				        <KnockoutGame game="1" field="2" time="4:00pm" tournament="co-rec"/>
				        <KnockoutGame game="2" field="3" time="4:00pm" tournament="co-rec"/>
				        <KnockoutGame game="3" field="4" time="4:00pm" tournament="co-rec"/>
				        <KnockoutGame game="4" field="5" time="4:00pm" tournament="co-rec"/>
				      </ul>
				    </div>
				    ...
				    <div className="tournament-bracket__round tournament-bracket__round--quarterfinals">
				      ...
				      <ul className="tournament-bracket__list" tournament="co-rec">
				        <KnockoutGame game="5" field="4" time="12:40pm" tournament="co-rec"/>
				        <KnockoutGame game="6" field="6" time="12:40pm" tournament="co-rec"/>
				      </ul>
				    </div>
				    ...
				    <div className="tournament-bracket__round tournament-bracket__round--gold">
				      <h3 className="tournament-bracket__round-title">Championship</h3>
				      <ul className="tournament-bracket__list">
				        <KnockoutGame game="7" field="4" time="2:00pm" tournament="co-rec"/>
				      </ul>
				    </div>
				  </div>
				</div>
